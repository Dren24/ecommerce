...
<div class="flex items-center justify-start gap-4 px-4 mt-6 ">
    ...
    <a href="{{ route('myorders.index') }}" class="w-full text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
      View My Orders
    </a>
</div>
